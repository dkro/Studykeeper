...
module.exports = function(app) {
  ...
  app.post('/api/users/logout', auth.tokenAuthenticate, auth.requiresRole(['self']), userController.logout);
  app.post('/api/users/changePassword', auth.tokenAuthenticate, auth.requiresRole(['self']), userController.changePW);
